<div>
<h2 class="text-center p-3">Update doctor</h2>
...
<div class="container mt-5 " style="border:1px solid black;padding:50px;">
    <div class="row d-flex justify-content-center">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input wire:model="name" value="{{$data->name}}" type="text" class="form-control" id="name" aria-describedby="nameHelp">
              </div>
    ...
    <div class="row d-flex justify-content-center mt-3">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input wire:model="email" type="email" class="form-control" id="email" placeholder="Enter email address">
              </div>
   ...
   <button wire:click.prevent="updateDr({{$data->id}})" style="width:30%" class="btn btn-primary">Enter doctor</button>
    </div>
</div>
</form>
@endif
