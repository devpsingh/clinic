<div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="dropdown-item" href="{{ route('doctor')}}"><i class="fas fa-user-md"></i> Doctors</a>
        ...
        <div class="d-flex justify-content-end">
                ...
                @if (Route::has('login'))
                    ...
                    <a class="text-muted" href="{{route('doctor.login')}}"><i class="fas fa-user-md"></i> Doctor login </a>
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-muted">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="text-muted"><i class="fas fa-user"></i> User Login</a>
